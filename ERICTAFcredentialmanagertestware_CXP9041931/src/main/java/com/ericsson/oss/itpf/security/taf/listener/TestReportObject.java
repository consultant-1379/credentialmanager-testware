...
package com.ericsson.oss.itpf.security.taf.listener;
...
public class TestReportObject implements ISuiteListener {
    ...
    private static final Integer STACK_TRACE_ELEMENTS = DataHandler.getConfiguration().getProperty("stacktrace.element.count", 5, Integer.class);
    ...
    private List<String> getMethodList(final Iterator methodListIterator, final Iterator methodResultIterator) {
        ...
        while (methodListIterator.hasNext()) {
            ...
            if (methodResultIterator != null) {
                ...
                for (int count = 0; count < STACK_TRACE_ELEMENTS; count++) {
                    if (count == 0) {
